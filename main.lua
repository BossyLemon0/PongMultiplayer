...
function love.load()
    ...
    gFrames = {
        ...
        ['powers'] = GenerateQuadsPowerUps(gTextures['main'])
    ...
    gSounds = {
        ...
        ['getkey'] = love.audio.newSource('sounds/pickup_key1.wav', 'static'),
        ['powerup'] = love.audio.newSource('sounds/powerup.wav', 'static'),
        ['multiball'] = love.audio.newSource('sounds/multiball.wav', 'static'),
...
function renderBallsInPlay(balls)
    love.graphics.setFont(gFonts['small'])
    love.graphics.print('Balls in play:', VIRTUAL_WIDTH - 230, 5)
    love.graphics.printf(tostring(balls), VIRTUAL_WIDTH - 190, 5, 40, 'right')
end